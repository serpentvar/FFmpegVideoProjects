...
"ffmpeg.exe" -hide_banner -y -i "!input_file!" -i "!subtitle_file!" -c:v libx264 -max_muxing_queue_size 9999 -preset veryslow -crf 18 -c:a copy -c:s mov_text -scodec mov_text "!temp_file!"
